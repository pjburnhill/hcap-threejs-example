(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MRCS = {}));
    ...
    })(exports.StreamMode || (exports.StreamMode = {}));
    var VideoStates;
    ...
    })(exports.ErrorStates || (exports.ErrorStates = {}));
    ...
    class HoloVideoObject {
        ...
        _loadJSON(src, callback) {
            ...
            xobj.onreadystatechange = () => {
                if (xobj.readyState == 4 &&
                    ...
                    this._onError(exports.ErrorStates.NetworkError);
                }
            };
            xobj.onerror = () => {
        ...
        _loadNextVideo() {
            ...
            if (this.openOptions.streamMode === undefined) {
                this.openOptions.streamMode = exports.StreamMode.Automatic;
            }
            ...
            if ((this.openOptions.streamMode == exports.StreamMode.HLS) ||
                (this.openOptions.streamMode == exports.StreamMode.Automatic && ((this.isSafari || this.isMozillaWebXRViewer) && imageExt.hlsUri && !hasIOS14HLSIssue))) {
                this._setVideoStartTime(video);
                video.src = this.urlRoot + imageExt.hlsUri;
                video.mp4Name = imageExt.hlsUri;
            }
            else if ((this.openOptions.streamMode == exports.StreamMode.Dash) ||
                (this.openOptions.streamMode == exports.StreamMode.Automatic && (!this.isSafari && !this.isMozillaWebXRViewer && imageExt.dashUri && typeof dashjs != "undefined"))) {
                if (!this.dashPlayer) {
            ...
            video.onerror = (e) => {
                ...
                this._onError(exports.ErrorStates.VideoError, target.error);
            };
            video.onended = () => {
            ...
            if (this.isSafari) {
                ...
                if (playPromise !== undefined) {
                    playPromise.catch(error => {
                        ...
                        this._onError(exports.ErrorStates.PlaybackPrevented, error);
                    });
                }
            }
        }
